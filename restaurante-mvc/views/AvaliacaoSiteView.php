        ...
        <form method='post' action='$baseUrl/avaliacoes/atualizar/$idCardapio'>
            ...
            <div class='row'>
                ...
                <div class='col-md-6 mt-3'>
                    <input type='text' name='nome' class='form-control shadow' placeholder='Seu nome'>
                </div>
                <div class='col-md-6 mt-3'>
                    <input type='email' name='email' class='form-control shadow' placeholder='Seu e-mail'>
                </div>

                <div class='col-md-12 mt-3'>
                    <textarea name='comentario' class='form-control shadow' placeholder='Faça seu comentário'></textarea>
                </div>
