            ...
            <div class="col-md-5">
               ...
               <div class="card mb-4 rounded-3 shadow-sm ">
                  <div class="card-header bg-secondary py-3">
                     <h4 class="my-0 fw-normal text-white"><i class="bi bi-lock"></i> Alterar Senha:</h4>
                  </div>
                  <div class="card-body p-4">

                     <!-- <?= $erro ?> -->

                     <p><small>Preencha o campo abaixo com a nova senha:</small></p>
                     ...
                     <form id="form1" name="form1" method="post" action="<?= $baseUrl ?>/usuarios-adm/atualizarSenha/<?= $idUsuario ?>">
                        ...
                        <button type="submit" id="btnEnviar" name="btnEnviar" class="w-100 btn btn-lg btn-secondary">Alterar <i class="bi bi-arrow-right"></i></button>
                     </form>
