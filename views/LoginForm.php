   ...
   <main>
      <div class="container mt-5">
         ...
         <div class="row d-flex justify-content-center">
            <div class="col-md-5">
               <p class="text-center fs-3">Restaurante <span class="text-info fw-bold"> MVC</span></p>
               <div class="card mb-4 rounded-3 shadow-sm ">
                  ...
                  <div class="card-body p-4">
                     ...
                     <form id="form1" name="form1" method="post" action="<?= $baseUrl ?>/login/autenticar">
                        ...
                        <div class="form-floating mb-3">
                           <input type="checkbox" name="manter logado" id="manter logado" value="1" class="form-check-input">
                           Manter logado
                        </div>
