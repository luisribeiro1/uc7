            ...
            <div class="col-md-5">
               ...
               <div class="card mb-4 rounded-3 shadow-sm ">
                  <div class="card-header bg-primary py-3">
                     <h4 class="my-0 fw-normal text-white"> <i class="bi bi-person-gear"></i> Alterar Senha</h4>
                  </div>
                  <div class="card-body p-4">
                     ...
                     <form id="form1" name="form1" method="post" action="<?= $baseUrl ?>/usuario/atualizarSenha/<?= $idUsuario?>">
                        ...
                        <button type="submit" class="w-100 btn btn-lg btn-primary"> <i class="bi bi-box-arrow-in-right"></i> Alterar Senha</button>
                     </form>
