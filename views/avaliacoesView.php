        ...
        <div class='card-footer d-flex justify-content-between'>
          <div class='row'>
            ...
            <div class='me-1'>
              ...
              <a class='text-secondary text-decoration-none' href='[[base-url]]/avaliacoes-adm/aprovar/$idAvaliacao' onclick=\"return confirm('autorizar a avaliacao $idAvaliacao?')\"><i class='bi bi-pencil-square'></i>Aprovar</a>
            </div>
          </div>
        </div>
