    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <form action="<?= $baseUrl ?>/cardapio-adm/atualizar" method="post">
                <label>Nome:</label>
                <input type="text" class="form-control" name="nome" id="nome" value="<?= $nome ?>" required placeholder="Nome do Prato">
                <br>
                
                <label>Preço:</label>
                <input type="number" class="form-control" name="preco" id="preco" required value="<?= $preco ?>" min="0" step="0.01" placeholder="Valor do prato">
                <br>
