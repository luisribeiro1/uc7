...
# Iterar sobre array que foi criado com ocntroller e que contem os dados das mesas.
   ...
   foreach($listaDeAvaliacoes as $item){
    ...
    # Inverter o Formato da Data, usando o método createFormFormat da classe Date time
    ...
    <form method='post' id='form1' action='$baseUrl/avaliacoes/atualizar/$idCardapio'>
        ...
        <div class='row'>
            ...
            <div class='col-md-12 mt-3'>
                <textarea name='comentario' id='comentario' class='form-control' placeholder='Faça seu comentario' required></textarea>
            </div>
            </div>
